# Bibliografi: Buku Pengelolaan Jurnal Elektronik dengan OJS 3.3

Dokumen ini menyimpan semua sumber yang ditemukan oleh agen peneliti. Format mengikuti **APA 7th Edition** sebagai default, dengan metadata tambahan untuk keperluan pelacakan.

---

## Petunjuk Penggunaan

- Setiap entri baru ditambahkan **di bawah entri terakhir** pada seksi yang sesuai.
- **Jangan hapus** entri yang sudah ada, meskipun duplikat — tandai saja dengan [DUPLIKAT → lihat BIB-XXX].
- Entri diberi ID unik berurutan: BIB-001, BIB-002, dst.
- Setiap entri memiliki tag relevansi ke bab dan ke ID knowledge base jika ada.
...
### Kelompok A — Standar dan Panduan Lembaga Internasional
*(DOAJ, COPE, Crossref, PKP, BOAI, Dublin Core, JATS, ORCID, dll.)*

**BIB-001**
Budapest Open Access Initiative. (2002). *Read the Budapest Open Access Initiative*. Open Society Institute.
- **URL**: https://www.budapestopenaccessinitiative.org/read/
- **Tipe sumber**: halaman-web
- **Relevansi Bab**: Bab 1, Bab 3
- **Terhubung ke KB**: KB-004
- **Diakses**: 2026-07-18
- **Status URL**: aktif
...
**BIB-002**
Public Knowledge Project. (2025). *Open Journal Systems*. Simon Fraser University Library.
- **URL**: https://pkp.sfu.ca/software/ojs/
- **Tipe sumber**: halaman-web
- **Relevansi Bab**: Bab 1, Bab 3
- **Terhubung ke KB**: KB-001, KB-002, KB-003
- **Diakses**: 2026-07-18
- **Status URL**: aktif
...
**BIB-004**
Directory of Open Access Journals. (2025). *DOAJ: Directory of Open Access Journals*.
- **URL**: https://doaj.org/
- **Tipe sumber**: halaman-web
- **Relevansi Bab**: Bab 1, Bab 3
...
### Kelompok B — Regulasi dan Kebijakan Nasional
*(Permendikbudristek, Permendiknas, Sinta, Garuda, RJI, dll.)*

**BIB-005**
Kementerian Pendidikan, Kebudayaan, Riset, dan Teknologi. (2024). *ARJUNA: Akreditasi Jurnal Nasional*. Kemendikbudristek.
- **URL**: https://arjuna.kemdikbud.go.id
- **Tipe sumber**: halaman-web
- **Relevansi Bab**: Bab 1, Bab 3
- **Terhubung ke KB**: KB-006
- **Diakses**: 2026-07-18
- **Status URL**: aktif
...
*(artikel jurnal, buku teks, laporan penelitian, prosiding)*

*(belum ada entri pada sesi ini — akan diisi pada sesi penelitian berikutnya)*

---

### Kelompok D — Dokumentasi Teknis
*(PKP Docs, GitHub, manual OJS, Pandoc docs, plugin docs, dll.)*
...
*(blog, forum, berita, opini, komunitas)*

**BIB-009**
Relawan Jurnal Indonesia. (2024). *Tentang RJI: Relawan Jurnal Indonesia*.
- **URL**: https://relawanjurnal.id/
- **Tipe sumber**: halaman-web
- **Relevansi Bab**: Bab 1, Bab 3
- **Terhubung ke KB**: KB-010
- **Diakses**: 2026-07-18
- **Status URL**: aktif
